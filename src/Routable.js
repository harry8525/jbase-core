(function ()
{
    ...
    "Shared.Routable",
    {
        ...
        ///#DEBUG
        _routes: /* @static_cast(Array) */ null,
        _reroutes: /* @static_cast(Array) */ null,
        _routedContentControl: /* @static_cast(JBase.UI.ContentControl) */ null,
        _currentRouteDescription: null,
        _onParamsChanged: null,
        _defaultRequire: [],
        ///#ENDDEBUG
        ...
        registerRouteContentControl: function(contentControl)
        {
            ...
            mix(contentControl, {
                getControlType: function(dataContext) { return dataContext.viewType; },
                getChildDataContext: function (dataContext) { return null; }
            });
        },

        registerRoute: function (routeResolveCallback, routeDescription)
        {
        ...
        registerUrlRoute: function (routes, routeDescription)
        {
        ...
        reroute: function(fromParam, toParam)
        {
        ...
        applyReroutes: function (viewParams)
        {
            var rerouted = false;

            for (var i = 0; /* @static_cast(Boolean) */this._reroutes && i < this._reroutes.length; i++)
            {
        ...
        evaluateRoutes: function ()
        {
            ...
            if (this.isRoutingEnabled)
            {
                ...
                var defaultRoute = /* @static_cast(*) */ null;
                var selectedRoute = /* @static_cast(*) */ null;
                ...
                if (!_this.applyReroutes(viewParams))
                {
                    ...
                    if (/* @static_cast(Boolean) */ selectedRoute && selectedRoute.description != _this._currentRouteDescription)
                    {
        ...
        onBeforeExecuteRoute: function(routeDescription, viewParams) {
            /// <summary>Overrideable callback to execute before executing a new route.</summary>
        },

        _executeRoute: function(routeDescription, viewParams)
        {
